...
public class RosSubscriberExample : MonoBehaviour
{
    ...
    void Start()
    {
        ROSConnection.GetOrCreateInstance().Subscribe<CompressedImageMsg>("/robot192168239217/compressedimage", ColorChange);
    }

    void ColorChange(CompressedImageMsg message)
    {
